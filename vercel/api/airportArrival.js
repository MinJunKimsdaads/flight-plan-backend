...
const AIRPORT_ARRIVAL_URL = 'https://opensky-network.org/api/flights/departure'
...
export default async function handler(req, res) {
  ...
  try{
    ...
    const response = await fetch(`${AIRPORT_ARRIVAL_URL}?airport=${encodeURIComponent(airport)}&begin=${encodeURIComponent(begin)}&end=${encodeURIComponent(end)}`, {
        method: "GET",
        headers,
    });
